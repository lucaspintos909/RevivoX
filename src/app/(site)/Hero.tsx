        ...
        <div className="w-full lg:w-1/2 mb-12 lg:mb-0 text-center lg:text-left">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4 sm:justify-center">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 bg-transparent border border-[#FF8806] hover:border-[#321B01] hover:bg-[#321B01] text-white px-8 py-3 rounded-xl font-medium text-lg transition-colors duration-300"
